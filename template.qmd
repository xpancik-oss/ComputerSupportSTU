...
```{r}
banska_bystrica_list$description      # description string
banska_bystrica_list[["city_matrix"]] # 3x3 matrix
banska_bystrica_list$numeric_vector[2] # second element from numeric_vector
```
